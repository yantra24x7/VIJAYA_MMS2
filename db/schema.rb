...
ActiveRecord::Schema.define(version: 20210429175237) do
  ...
  create_table "macro_signal_openeds", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["machines_id"], name: "index_macro_signal_openeds_on_machines_id", using: :btree
  end
  ...
  create_table "macro_signals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["machines_id"], name: "index_macro_signals_on_machines_id", using: :btree
  end
  ...
  create_table "operator_allot_details", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["tenant_id"], name: "index_operator_allot_details_on_tenant_id", using: :btree
  end
  ...
  add_foreign_key "macro_signal_openeds", "machines", column: "machines_id"
  add_foreign_key "macro_signals", "machines", column: "machines_id"
  ...
  add_foreign_key "operator_allot_details", "tenants"
